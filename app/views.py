...
def mobile(request, data=None):
 ...
 if data == None:
   mobiles = Product.objects.filter(category='M')
 elif data == 'Redmi' or data == 'Samsung' or data == 'Realme' or data == 'Apple' or data == 'Nokia':
...
def laptop(request, data=None):
 ...
 if data == None:
   laptops = Product.objects.filter(category='L')
 elif data == 'Lenovo' or data == 'Acer' or data == 'Dell' or data == 'Apple' or data == 'Microsoft':
...
def topwear(request, data=None):
 ...
 if data == None:
   topwears = Product.objects.filter(category='TW')
 elif data == 'Amazon' or data == 'Levis' or data == 'Nike' or data == 'GUCCI' or data == 'Adidas':
